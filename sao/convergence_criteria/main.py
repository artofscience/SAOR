...
from ApproximationSchemes.NonMixed.SecondOrderDiagonalTaylor import SecondOrderDiagonalTaylor
...
def main():
    ...
    approx = SecondOrderDiagonalTaylor(MMA(prob.n, prob.m, prob.xmin, prob.xmax), second_order=True)
