...
class MMA87B(MMAp):
    ...
    """
    def __init__(self, s=0.7, l0=0, u0=5, lmin=-50, lmax=0.4, umin=2.5, umax=50, oscillation_tol = 1e-10, p=-1, factor=0.01):
        super().__init__(p=p, factor=factor)
...
class MMA02(MMAp):
    def __init__(self, x_min=0.0, x_max=1.0, sinit=0.5, sincr=1.2, sdecr=0.7, asybound=10.0, oscillation_tol=1e-10, p=-1, factor=0.01):
        super().__init__(p=p, factor=factor)
        self.x, self.xold1, self.xold2 = None, None, None
        self.dx = x_max-x_min
