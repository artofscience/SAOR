import numpy as np
import logging
from Problems.topology_optimization_benchmark.Compliant_inverter import Inverter
...
def test_inverter(nelx=100, nely=200, volfrac=0.2, penal=3, rmin=2):

    # Instantiate problem
    prob = Inverter(nelx, nely, volfrac, penal, rmin, kin=0.001, kout=0.001)
