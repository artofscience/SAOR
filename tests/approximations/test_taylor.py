...
def test_taylor1_intervening(n, h):
    ...
    assert taylor1.dg(inter.y(prob.x).T, inter.dydx(prob.x)) == pytest.approx(prob.dg(prob.x), rel=1e-4)
    assert taylor1.ddg(inter.y(prob.x).T, inter.dydx(prob.x), inter.ddyddx(prob.x)) == pytest.approx(dfdy * inter.ddyddx(prob.x), abs=1e-4)
    ...
    assert taylor1.dg(inter.y(prob.x + h).T, inter.dydx(prob.x + h)) == pytest.approx(dfdy * inter.dydx(prob.x + h), rel=1e-4)
    assert taylor1.ddg(inter.y(prob.x + h).T, inter.dydx(prob.x + h), inter.ddyddx(prob.x + h)) == pytest.approx(dfdy * inter.ddyddx(prob.x + h), rel=1e-4)
...
def test_taylor2_intervening(n, h):
    ...
    assert taylor2.dg(inter.y(prob.x).T, inter.dydx(prob.x)) == pytest.approx(prob.dg(prob.x), rel=1e-4)
    assert taylor2.ddg(inter.y(prob.x).T, inter.dydx(prob.x), inter.ddyddx(prob.x)) == pytest.approx(prob.ddg(prob.x), rel=1e-4)
    ...
    assert taylor2.dg(inter.y(prob.x + h).T, inter.dydx(prob.x + h)) == pytest.approx(dfdy * inter.dydx(prob.x + h) +
                                                                                    ddfddy * delta_y.T * inter.dydx(prob.x + h), rel=1e-4)
    assert taylor2.ddg(inter.y(prob.x + h).T, inter.dydx(prob.x + h), inter.ddyddx(prob.x + h)) == pytest.approx(dfdy * inter.ddyddx(prob.x + h) +
                                                                                                            ddfddy * delta_y.T * inter.ddyddx(prob.x + h) +
                                                                                                            ddfddy * inter.dydx(prob.x + h) ** 2, rel=1e-4)
